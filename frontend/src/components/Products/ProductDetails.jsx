...
const ProductDetails = ({ productId }) => {
  ...
  if (loading || !selectedProduct) return <p>Loading product details...</p>;
      ...
      <div className="max-w-6xl mx-auto bg-white p-8 rounded-lg">
        <div className="flex flex-col md:flex-row">
          ...
          <div className="md:w-1/2 mb-4 md:mb-0">
            {mainImage && (
              <img src={mainImage} alt={selectedProduct.name} className="w-full h-auto object-cover rounded-lg" />
            )}
          </div>
          ...
          <div className="md:w-1/2 md:ml-10">
            ...
            {selectedProduct.originalPrice && <p className="text-lg text-gray-600 mb-1 line-through">{selectedProduct.originalPrice}</p>}
            ...
            <div className="mb-6">
              ...
              <div className="flex items-center space-x-4 mt-2">
                <button onClick={() => handleQuantityChange("minus")} className="px-3 py-1 bg-gray-200 rounded text-lg">−</button>
                <span className="text-lg">{quantity}</span>
                <button onClick={() => handleQuantityChange("plus")} className="px-3 py-1 bg-gray-200 rounded text-lg">+</button>
              </div>
            </div>
