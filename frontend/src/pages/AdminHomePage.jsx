...
const AdminHomePage = () => {
  ...
  return <div className="max-w-7xl mx-auto p-6">
    ...
    {productsLoading || ordersLoading ? (<p>Loading ...</p>) : productsError ? (<p className="text-red-500">Error fetching products : {productsError}</p>) : ordersError ? (<p className="text-red-500">Error orders products : {ordersError}</p>) : (
